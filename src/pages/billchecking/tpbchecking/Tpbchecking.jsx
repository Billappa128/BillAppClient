...
import styles from "./Tpbchecking.module.css"
...
export default function Tpbchecking() {
    ...
    const imageOptions = [
        { value: 'image1', label: 'Hình Nền 1', path: images.tpbchecking },
                ...
                <div className={styles.content}>
                    <div className={styles.left}>
                        <form onSubmit={handleFormSubmit}>
                            ...
                            <button type="submit" className="btn-c btn-block mb-4">Place order</button>
                        </form>
                    </div>
