...
import styles from "./Sacombanking.module.css"
...
export default function Sacombanking() {
    ...
    const imageOptions = [
        { value: 'image1', label: 'Hình Nền 1', path: images.sacombaking },
            ...
            <div className="content-body pb-5">
                ...
                <div className={styles.content}>
                    ...
                    <div ref={componentRef} className={`${styles.right} position-relative`}>
                        ...
                        <span className={`${styles.feed} position-absolute`}>{`Chuyển tiền từ thẻ Sacombank Debit đến TK NH nội địa`}</span>
                        ...
                        <span className={`${styles.receiverName} position-absolute`}>{``}</span>
