...
import styles from "./Bidvbanking.module.css"
import BIDV from "../../../../images/billbanking/ck-bidv.jpg"
...
export default function Bidvbanking() {
    ...
    const imageOptions = [
        { value: 'image1', label: 'Hình Nền 1', path: BIDV },
