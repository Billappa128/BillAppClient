...
import styles from "./Msbbanking.module.css"
import MSB from "../../../../images/billbanking/ck-msb.jpg"
...
export default function Msbbanking() {
    ...
    const imageOptions = [
        { value: 'image1', label: 'Hình Nền 1', path: MSB },
            ...
            <div className="content-body pb-5">
                ...
                <div className={styles.content}>
                    ...
                    <div ref={componentRef} className={`${styles.right} position-relative`}>
                        ...
                        <span className={`${styles.time} position-absolute`}>{`${time} ${formattedDate}`}</span>
                        <span className={`${styles.senderAccount} position-absolute text-capitalize`}>{senderAccount}</span>
