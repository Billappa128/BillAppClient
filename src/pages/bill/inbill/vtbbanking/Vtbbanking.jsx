...
import styles from "./Vtbbanking.module.css"
import VTB from "../../../../images/billbanking/ck-vtb.jpg"
import VTB1 from "../../../../images/billbanking/ck-vtb1.jpg"
...
export default function Vtbbanking() {
    ...
    const imageOptions = [
        { value: 'image1', label: 'Hình Nền 1', path: VTB },
        { value: 'image2', label: 'Hình Nền 2', path: VTB1 },
            ...
            <div className="content-body pb-5">
                ...
                <div className={styles.content}>
                    ...
                    <div ref={componentRef} className={`${styles.right} position-relative`}>
                        ...
                        <span className={`${styles.time} position-absolute`}>{`${formattedDate} ${time}`}</span>
