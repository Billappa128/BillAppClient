...
import styles from "./Tpbanking.module.css"
import TP from "../../../../images/billbanking/ck-tpb.jpg"
...
export default function Tpbanking() {
    ...
    function generateCustomString() {
        const prefix = Math.floor(Math.random() * 1000).toString().padStart(3, '0'); // Tạo 3 kí tự số ngẫu nhiên
        const suffix = 'V';
        return prefix + suffix + randomNumericString;
      }
    ...
    const imageOptions = [
        { value: 'image1', label: 'Hình Nền 1', path: TP },
    ...
    const [formState, setFormState] = useState({
        date: "",
        time: "",
        transactionCode: generateCustomString(),
        senderNumber: "",
        senderAccount: "",
        receiverAccount: "",
        receiverName: "",
    ...
    const { date, time, transactionCode, senderNumber, senderAccount, receiverAccount, receiverName, description } = formState;
            ...
            <div className="content-body pb-5">
                ...
                <div className={styles.content}>
                    ...
                    <div ref={componentRef} className={`${styles.right} position-relative`}>
                        ...
                        <span className={`${styles.date} position-absolute`}>{`${time}:17, ${getFormattedDate(date)}`}</span>
                        ...
                        {selectedBankData && <div className={`${styles.imageContainer} position-absolute`}><img src={selectedBankData.icon} className={`${styles.iconBank}`}  alt="iconBank" /></div>}
