...
export default function AgrBanking() {
    ...
    const imageOptions = [
        { value: 'image1', label: 'Hình Nền 1', path: AGR },
    ...
    const { date, time, transactionCode, receiverAccount, receiverName, amountText, description } = formState;
